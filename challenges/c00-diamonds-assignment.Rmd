...
- It seems that commonly, the carat value of a diamond will be a multiple of 0.5, perhaps due to ease of understanding for those who aren't knowledgeable with diamonds. As for the relationship with price and carat value, the relationship is positive with the higher carat value tending to cost more. Our dataset had more values of lower carat and cost values, likely due to these diamonds being more common than diamonds with high carat values. There is almost a "hard stop" around a price of $18k with most diamonds under a price of $10k.
