...
- Write your observations here!
  - Most of the measurements were rated good distinctness, but this was followed closely by fair distinctness. 15% of the measurements were rated to have poor distinctness and this group of measurements had a mean velocity of 299808.0 km/s, over 50 km/s below the other two groups. The groups of good and fair distinctness have relatively close mean velocities that sit around 299860 km/s.
- Why might your table differ from Michelson's?
  - My table is different from Michelson's because his is rounded to the nearest tens place, whereas mine is rounded to the nearest tenths place. That is why we have similar values in the same range but not the same values in our tables for MeanVelocity.
...
- Is Michelson's estimate of the error (his uncertainty) greater or less than the true error?
  - Michelson's estimate of the error is less than the true error. The estimate of his error was plus or minus 51 km/s, but the actual error was 151.542 km/s which is relatively far off.
- Make a quantitative comparison between Michelson's uncertainty and his error.
  - Michelson's uncertainty was about a third of this actual error, with his uncertainty being 51 km/s and his error being 151.542 km/s. This means that his error was about three times greater than he anticipated through his measurements. 
...
- The mean velocity in vacuum tends to stay within 100 km/s of the actual speed of light, with about one exception in each data set. 

Differences
- The simulated results tend to stay within the estimated error a lot more than the actual results do. This would makes sense because if Michelson simulated this and found that his data sat way out of his error range, he would have probably adjusted his uncertainty.
- The real results vary more than the simulated results, with the simulated results generally staying relatively flat. 
...
- The simulated data seems to have more outliers than the real data. The outliers of the real data are more spread out from one another than the outliers of the simulated data. 
