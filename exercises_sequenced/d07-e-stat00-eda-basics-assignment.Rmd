...
**Observations**:
- The ideal cut was the most common diamond in the dataset. With the quality of cut decreasing, the quantity of diamonds with the respective quality of cut decreases. This left ideal cut diamonds to be the most numerous and fair cut diamonds to be the least numerous. This means the hypothesis was incorrect.
...
**Observations**:
- This plot isn't the best to be able to answer this hypothesis. That being said, we can see from this graph that all the different cuts have diamonds that are valued around the most expensive diamond. Fair cuts and good cuts fade out a little toward the top of the graph, showing they have less diamonds that are valued so high. I would say that this hypothesis is incorrect because other cut diamonds are valued around equally as high, but this graph makes that difficult to conclude with confidence.
...
**Observations**:
- This does not support the hypothesis because from this graph, we can see that on average, ideal cut diamonds are priced lower than any other cut of diamond. Beyond this, we can see that a three quarters of the ideal cut diamonds are priced below $5000 dollars, making it the cut with the most diamonds under $5000. Furthermore, we don't see a definite pattern or correlation between cut and price, as they have similar means despite ideal cut diamonds being the lowest mean and fair cut diamonds being around the highest mean.
...
**Observations**:
- Supporting the Wikipedia article, the fair cut diamonds are on average, 1.0 carat. This makes sense because diamond cutters will choose to cut the diamonds worse so that the carat value will be 1.0, which is more desirable to diamond buyers despite. This would explain why we saw fair diamonds costing more: the fair cut is often to cut the diamond to 1.0 carat, a more desirable and expensive diamond. 
