...
iris %>% filter(Sepal.Length >= 5.1 & Sepal.Length <= 6.4)
...
### __q5__ Look up the documentation on `cut_number`; what package does it come from? What about `parse_number()`? What about `row_number()`?
cut_number
?cut_number
?parse_number
?row_number

## cut_number from ggplot2, parse_number from readr, row_number from dplyr
