...
- The names don't properly match up with the surnames because they are out of order and there wasn't a way to match them up otherwise. This is because there was no overlapping data between the two sets.
...
left_join(beatles1, beatles3, by = "name")
right_join(df_q2, beatles2, by = "surname")
df_q2
```
