...
- Does the "gam" trend look linear?
  The "gam" trend does not look linear, it goes up to about $15000, then it stops increasing and levels off in a way. This does not look like a linear relationship.
...
mpg %>%
  ...
  geom_label_repel(mapping = aes(label = ))
```
